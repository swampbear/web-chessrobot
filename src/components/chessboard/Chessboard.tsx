...
export default function Chessboard() {
    const[isPlayingWhite, setIsPlatingWhite] = useState(true)
    ...
    const[currentBoardFEN, setCurrentBoardFEN] = useState<string>(correctBoardFEN) //should be fed from the board irl through socket
    ...
    function reverseFENString(FEN: string){
        setIsPlatingWhite(!isPlayingWhite)
